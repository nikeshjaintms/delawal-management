...
class PropertyMasterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'due_amount'     => 'nullable|numeric|min:0|max:999999999999999',
            'purchase_date'  => 'nullable|date',
            'purchase_rate'  => 'nullable|numeric|min:0|max:999999999999999',
            'total_area'     => 'nullable|numeric|min:0|max:999999999999999',
            ...
            'broker_commission_rate' => 'nullable|numeric|min:0|max:1000',
            'broker_commission_amount' => 'nullable|numeric|min:0|max:999999999999999',
