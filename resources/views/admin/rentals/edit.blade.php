...
<div class="card-box">
    <form method="POST" action="{{ route('rentals.update', $rental->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-row" style="margin-bottom: 16px;">
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <input type="text" name="agreement_no" id="agreement_no"
                           value="{{ old('agreement_no', $rental->agreement_no) }}"
            ...
            <div class="form-group" style="margin-bottom: 0;">
                ...
                <select name="property_ids[]" id="property_ids" class="form-control select2-units @error('property_ids') is-invalid @enderror @error('property_id') is-invalid @enderror" multiple required data-placeholder="-- Click to Select One or Multiple Units / Properties --" style="width: 100%;">
                    @foreach($properties as $property)
                        @php
                            $oldProps = old('property_ids', $selectedPropertyIds ?? ($rental->property_id ? [$rental->property_id] : []));
        ...
        <div class="form-section">
            ...
            <input type="hidden" name="tenant_id" id="tenant_id" value="{{ old('tenant_id', $rental->tenant_id) }}">
                    ...
                    @if(isset($tenants))
                        @foreach($tenants as $t)
                            <option value="{{ $t->id }}"
                                    ...
                                    {{ old('tenant_id', $rental->tenant_id) == $t->id ? 'selected' : '' }}>
            ...
            <div class="form-row-3">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="handover_date" id="handover_date"
                           value="{{ old('handover_date', $rental->handover_date ? \Carbon\Carbon::parse($rental->handover_date)->format('Y-m-d') : '') }}"
            ...
            <div class="form-row-3">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="lock_in_period" id="lock_in_period" min="0"
                           value="{{ old('lock_in_period', $rental->lock_in_period) }}" class="form-control @error('lock_in_period') is-invalid @enderror" placeholder="e.g. 6 or 11">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="notice_period" id="notice_period" min="0"
                           value="{{ old('notice_period', $rental->notice_period ?? 30) }}" class="form-control @error('notice_period') is-invalid @enderror" placeholder="e.g. 30">
            ...
            <div class="form-row-3">
                <div class="form-group">
                    ...
                    <input type="text" name="meter_reading" id="meter_reading"
                           value="{{ old('meter_reading', $rental->meter_reading) }}"
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="escalation_percent" id="escalation_percent" min="0" max="100"
                           value="{{ old('escalation_percent', $rental->escalation_percent ?? 5) }}" class="form-control @error('escalation_percent') is-invalid @enderror" placeholder="e.g. 5 or 10">
                    @error('escalation_percent') <div class="text-error">{{ $message }}</div> @enderror
                </div>
                <div class="form-group">
                    <label class="form-label" for="agreement_document">Upload New Agreement (PDF/Image)</label>
                    ...
                    @if($rental->agreement_document)
                        <div class="form-hint" style="margin-top:6px;">
                            <a href="{{ asset('storage/' . $rental->agreement_document) }}" target="_blank" style="color:#60A5FA;text-decoration:underline;">
                                <i class="fa-solid fa-paperclip"></i> View Current Document
                            </a>
                        </div>
                    @endif
