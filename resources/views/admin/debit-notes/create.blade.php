...
<div class="crud-header">
    <div class="crud-title"><h2>Add Debit Note</h2><p>Record a new vendor debit adjustment or payable deduction.</p></div>
</div>
...
<div class="card-box">
    <form method="POST" action="{{ route('debit-notes.store') }}">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label">Debit Note No <span class="opt">(optional)</span></label>
                    <input type="text" name="debit_note_no" value="{{ old('debit_note_no') }}" class="form-control @error('debit_note_no') is-invalid @enderror" placeholder="e.g. DN-2026-001">
                    @error('debit_note_no')<div class="text-error">{{ $message }}</div>@enderror
                </div>
                <div class="form-group">
                    <label class="form-label">Date <span>*</span></label>
                    <input type="date" name="debit_note_date" value="{{ old('debit_note_date', date('Y-m-d')) }}" class="form-control @error('debit_note_date') is-invalid @enderror">
                    @error('debit_note_date')<div class="text-error">{{ $message }}</div>@enderror
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label">Vendor / Supplier <span class="opt">(optional)</span></label>
                ...
                <div class="form-group">
                    <label class="form-label">Related Bill No <span class="opt">(optional)</span></label>
                    <input type="text" name="related_bill_no" value="{{ old('related_bill_no') }}" class="form-control @error('related_bill_no') is-invalid @enderror" placeholder="e.g. BILL-2026-045">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="reason" class="form-control @error('reason') is-invalid @enderror" placeholder="Reason for debit note...">{{ old('reason') }}</textarea>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="taxable_amount" id="taxable_amount"
                           value="{{ old('taxable_amount',0) }}" class="form-control @error('taxable_amount') is-invalid @enderror" placeholder="0.00" oninput="calcDebit()">
            ...
            <div class="form-row-3">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="cgst_amount" id="cgst_amount" value="{{ old('cgst_amount',0) }}" class="form-control @error('cgst_amount') is-invalid @enderror" placeholder="0.00" oninput="calcDebit()">
                </div>
            ...
            <div class="form-row-3">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="sgst_amount" id="sgst_amount" value="{{ old('sgst_amount',0) }}" class="form-control @error('sgst_amount') is-invalid @enderror" placeholder="0.00" oninput="calcDebit()">
                </div>
                <div class="form-group" style="display:flex;align-items:flex-end;">
            ...
            <div class="form-row-3">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="igst_amount" id="igst_amount" value="{{ old('igst_amount',0) }}" class="form-control @error('igst_amount') is-invalid @enderror" placeholder="0.00" oninput="calcDebit()">
                </div>
                <div class="form-group" style="display:flex;align-items:flex-end;">
            ...
            <div class="calc-box">
                ...
                <div class="calc-row" style="border-top:1px solid rgba(239,68,68,0.15);margin-top:6px;padding-top:6px;">
                    <span style="font-weight:700;font-size:14px;">Debit Amount (Grand Total)</span>
                    <span style="font-weight:800;font-size:16px;color:#DC2626;" id="calc_debit">₹0.00</span>
                </div>
            </div>
        </div>
        ...
        <div class="form-actions">
            <button type="submit" class="btn-red"><i class="fa-solid fa-check"></i> Save Debit Note</button>
            <a href="{{ route('debit-notes.index') }}" class="btn-outline"><i class="fa-solid fa-arrow-left"></i> Back</a>
        </div>
    </form>
</div>
...
document.addEventListener('DOMContentLoaded', calcDebit);
</script>
@endsection
