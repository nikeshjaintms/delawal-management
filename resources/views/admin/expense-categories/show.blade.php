...
<style>
    ...
    .profile-info p { font-size: 13.5px; color: var(--text-secondary); }
    .profile-badges { display: flex; gap: 10px; flex-wrap: wrap; margin-top: 8px; }
...
<div class="crud-header">
    <div class="crud-title">
        ...
        <p>Full details of this firm-wise expense category.</p>
    </div>
</div>
...
<div class="card-box">
    ...
    <div class="profile-header">
        ...
        <div class="profile-info">
            ...
            <div class="profile-badges">
                <span class="badge badge-{{ $expenseCategory->status }}">{{ ucfirst($expenseCategory->status) }}</span>
            </div>
        </div>
    </div>
    ...
    <div class="detail-grid">
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">{{ $expenseCategory->firm_names }}</div>
        </div>
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">{{ $expenseCategory->name }}</div>
        </div>
    ...
    <div class="meta-info">
        <div class="meta-item">
            ...
            <span>Created: {{ $expenseCategory->created_at->format('d M Y, h:i A') }}</span>
        </div>
        <div class="meta-item">
            <i class="fa-regular fa-calendar-check"></i>
            <span>Last Updated: {{ $expenseCategory->updated_at->format('d M Y, h:i A') }}</span>
        </div>
    </div>

    <!-- Action Buttons -->
    <div class="form-actions">
        <a href="{{ route('expense-categories.edit', $expenseCategory->id) }}" class="btn-gold">
            <i class="fa-regular fa-pen-to-square"></i> Edit Expense Category
        </a>
        <a href="{{ route('expense-categories.index') }}" class="btn-outline">
