...
<div class="crud-header">
    <div class="crud-title">
        ...
        <p>Update category details — <strong>{{ $expenseCategory->name }}</strong></p>
    </div>
</div>
    ...
    <form method="POST" action="{{ route('expense-categories.update', $expenseCategory->id) }}">
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                      placeholder="Describe what type of expenses will be tracked under this category">{{ old('description', $expenseCategory->description) }}</textarea>
            @error('description') <div class="text-error">{{ $message }}</div> @enderror
        </div>

        <div class="form-actions">
            <button type="submit" class="btn-gold">
                <i class="fa-solid fa-floppy-disk"></i> Update Expense Category
            </button>
