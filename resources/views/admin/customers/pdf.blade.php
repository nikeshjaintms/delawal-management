...
<head>
    ...
    <title>Customers Directory Report - Delawala Management</title>
    <style>
...
<div class="rpt-header">
    ...
    <div class="rpt-meta">
        <div class="rpt-title">Customers Directory</div>
...
<div class="stat-row">
    <div class="stat-box">
        ...
        <div class="s-value">{{ $totalCustomers }}</div>
    </div>
...
<div class="section-label">&#9632; Customer Records</div>
<table>
    <thead>
        <tr>
    ...
    <tbody>
        ...
        @empty
        <tr><td colspan="9" style="text-align:center;padding:20px;color:#64748B;">No customer records found.</td></tr>
        @endforelse
    </tbody>
</table>

<div class="rpt-footer">
    <span>Delawala Management System &nbsp;—&nbsp; Customers Directory</span>
    <span>{{ $customers->count() }} customers &nbsp;|&nbsp; {{ now()->format('d M Y') }}</span>
</div>
