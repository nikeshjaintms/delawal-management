    ...
    <form method="POST" action="{{ route('customers.store') }}">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="alternate_mobile" id="alternate_mobile" value="{{ old('alternate_mobile') }}" class="form-control @error('alternate_mobile') is-invalid @enderror" placeholder="Enter alternate 10-digit mobile number (optional)" maxlength="10" pattern="[0-9]{10}" inputmode="numeric">
