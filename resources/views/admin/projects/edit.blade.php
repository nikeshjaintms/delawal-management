...
<div class="crud-header">
    <div class="crud-title">
        <h2>Edit Project</h2>
        <p>Update project details and plot allocations from Property Masters.</p>
    </div>
...
<div class="card-box">
    <form method="POST" action="{{ route('projects.update', $project->id) }}" enctype="multipart/form-data" id="projectEditForm">
        ...
        @php
            ...
            $assignedPlotIds = $project->properties->pluck('id')->toArray();
        @endphp
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="country" id="country" value="{{ old('country', $project->country) }}" class="form-control @error('country') is-invalid @enderror">
        ...
        <div class="form-group">
            ...
            @if($project->project_image)
                <div class="current-image-preview">
                    <img src="{{ asset('storage/' . $project->project_image) }}" alt="Project Image">
                </div>
            @endif
