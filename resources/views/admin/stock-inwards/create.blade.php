...
<div class="crud-header"><div class="crud-title"><h2>Add Stock Inward</h2><p>Record a new material purchase or stock receipt.</p></div></div>
<div class="card-box">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="inward_date" id="inward_date" value="{{ old('inward_date',date('Y-m-d')) }}" class="form-control @error('inward_date') is-invalid @enderror">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_name" id="supplier_name" value="{{ old('supplier_name') }}" class="form-control @error('supplier_name') is-invalid @enderror" autocomplete="off" placeholder="Enter supplier name">
                </div>
                <div class="form-group">
                    <label class="form-label" for="bill_no">Bill / Invoice No</label>
                    <input type="text" name="bill_no" id="bill_no" value="{{ old('bill_no') }}" class="form-control @error('bill_no') is-invalid @enderror" autocomplete="off" placeholder="Enter bill number">
                </div>
            </div>
            <div class="form-group">
