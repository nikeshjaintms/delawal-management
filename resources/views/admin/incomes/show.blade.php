...
<div class="card-box">
    <div class="detail-grid">
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">₹{{ number_format($income->amount, 2) }}</div>
        </div>
        ...
        <div class="detail-item detail-item-full">
            ...
            @if($income->description)
                <div class="detail-value" style="font-weight:400;font-size:14px;line-height:1.6;">{{ $income->description }}</div>
            @else
