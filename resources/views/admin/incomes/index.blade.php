...
<style>
    ...
    .total-bar{background:linear-gradient(135deg,rgba(16,185,129,0.08) 0%,rgba(16,185,129,0.02) 100%);border:1px solid rgba(16,185,129,0.2);border-radius:10px;padding:14px 20px;margin-bottom:18px;display:flex;align-items:center;gap:14px;flex-wrap:wrap;}
    .total-bar .total-label{font-size:12.5px;color:var(--text-secondary);}
    .total-bar .total-amount{font-size:20px;font-weight:800;color:#059669;}
    ...
    .type-chip{padding:3px 10px;border-radius:6px;font-size:11.5px;font-weight:700;border:1px solid transparent;display:inline-block;white-space:nowrap;}
    .type-rent{background:rgba(59,130,246,0.1);color:#1D4ED8;border-color:rgba(59,130,246,0.2);}
    .type-property-sale{background:rgba(139,92,246,0.1);color:#6D28D9;border-color:rgba(139,92,246,0.2);}
    .type-commission{background:rgba(245,158,11,0.1);color:#B45309;border-color:rgba(245,158,11,0.2);}
    .type-interest{background:rgba(14,165,233,0.1);color:#0369A1;border-color:rgba(14,165,233,0.2);}
    .type-other{background:#F1F5F9;color:#475569;border-color:var(--border-color);}
...
<div class="card-box">
    ...
    {{-- Total Amount Bar --}}
    <div class="total-bar">
        <i class="fa-solid fa-arrow-trend-up" style="color:#059669;font-size:18px;"></i>
        <div>
    ...
    <div class="table-container">
        <table class="premium-table">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="8" align="center" style="padding:40px;color:var(--text-secondary);">
