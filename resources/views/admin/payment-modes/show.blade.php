...
<div class="crud-header">
    <div class="crud-title">
        ...
        <p>Full details of this firm-wise payment method.</p>
    </div>
</div>
...
<div class="card-box">
    ...
    <div class="profile-header">
        <div class="mode-avatar">
            {{ strtoupper(substr($paymentMode->name, 0, 1)) }}
        </div>
        <div class="profile-info">
            <h3>{{ $paymentMode->name }}</h3>
            <p>Payment Method</p>
            <div class="profile-badges">
                <span class="badge badge-{{ $paymentMode->status }}">{{ ucfirst($paymentMode->status) }}</span>
            </div>
        </div>
    </div>
    ...
    <div class="detail-grid">
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">{{ $paymentMode->firm_names }}</div>
        </div>
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">{{ $paymentMode->name }}</div>
        </div>
    ...
    <div class="meta-info">
        <div class="meta-item">
            ...
            <span>Created: {{ $paymentMode->created_at->format('d M Y, h:i A') }}</span>
        </div>
        <div class="meta-item">
            <i class="fa-regular fa-calendar-check"></i>
            <span>Last Updated: {{ $paymentMode->updated_at->format('d M Y, h:i A') }}</span>
        </div>
    </div>

    <!-- Action Buttons -->
    <div class="form-actions">
        <a href="{{ route('payment-modes.edit', $paymentMode->id) }}" class="btn-gold">
            <i class="fa-regular fa-pen-to-square"></i> Edit Payment Mode
        </a>
        <a href="{{ route('payment-modes.index') }}" class="btn-outline">
