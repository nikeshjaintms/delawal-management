...
<div class="card-box">
    <form method="POST" action="{{ route('payment-modes.store') }}">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                      placeholder="Add payment mode details or usage notes">{{ old('description') }}</textarea>
            @error('description') <div class="text-error">{{ $message }}</div> @enderror
        </div>

        <div class="form-actions">
            <button type="submit" class="btn-gold">
                <i class="fa-solid fa-check"></i> Save Payment Mode
            </button>
