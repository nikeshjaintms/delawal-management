        ...
        <div class="form-section">
            ...
            <div class="form-row-4">
                @php
                    ...
                    $oldUnit = old('unit', '');
                    $isCustomUnit = $oldUnit && !in_array($oldUnit, $standardUnits);
                @endphp
                <div class="form-group">
                    ...
                    <div id="custom_unit_box" style="margin-top: 8px; display: {{ $isCustomUnit ? 'block' : 'none' }};">
                        <input type="text" id="custom_unit_input" value="{{ $oldUnit }}" class="form-control" placeholder="Type custom unit (e.g. Tanker, Drums)..." oninput="handleCustomUnitInput(this.value)">
                        <div class="form-hint" style="color: #60A5FA !important;"><i class="fa-solid fa-check"></i> Custom unit will be saved.</div>
                    </div>

                    <input type="hidden" name="unit" id="unit" value="{{ $oldUnit }}">
