...
<div class="crud-header">
    <div class="crud-title">
        <h2>Add Role</h2>
        <p>Create a new role to assign to users.</p>
    </div>
</div>
    ...
    <form method="POST" action="{{ route('roles.store') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="role_name" id="role_name" value="{{ old('role_name') }}"
                class="form-control @error('role_name') is-invalid @enderror" placeholder="e.g. Manager, Accountant" required>
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" rows="3"
                class="form-control @error('description') is-invalid @enderror" placeholder="Brief description of what this role can do">{{ old('description') }}</textarea>
