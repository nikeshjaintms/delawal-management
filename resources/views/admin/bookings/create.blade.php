...
<style>
    ...
    @media(max-width:640px){.form-row,.form-row-3{grid-template-columns:1fr;gap:0;}}
...
<div class="crud-header">
    <div class="crud-title">
        ...
        <p>Register a property booking with customer and payment details.</p>
    </div>
</div>
    ...
    <form method="POST" action="{{ route('bookings.store') }}">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="date" name="booking_date" value="{{ old('booking_date', date('Y-m-d')) }}" class="form-control @error('booking_date') is-invalid @enderror">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="booking_amount" value="{{ old('booking_amount') }}" class="form-control @error('booking_amount') is-invalid @enderror" placeholder="0.00">
        ...
        <div class="form-group">
            ...
            <textarea name="remarks" class="form-control @error('remarks') is-invalid @enderror" rows="3" placeholder="Additional notes...">{{ old('remarks') }}</textarea>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function filterPropertiesByProject() {
            ...
            // If selected property is now hidden, reset or select first valid match
        ...
        if (projSelect && propSelect) {
            ...
            // If a project is preselected (e.g. from old input), filter on load
            if (projSelect.value) {
