...
<div class="crud-header">
    <div class="crud-title">
        <h2>Add Broker</h2>
        <p>Add and manage real estate broker details.</p>
    </div>
</div>
    ...
    <form method="POST" action="{{ route('brokers.store') }}">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter broker name">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" step="0.01" min="0" max="100" name="commission_percentage" id="commission_percentage" value="{{ old('commission_percentage') }}" class="form-control @error('commission_percentage') is-invalid @enderror" placeholder="Enter broker commission percentage, e.g. 2.50">
        ...
        <div class="form-actions">
            <button type="submit" class="btn-gold">
                <i class="fa-solid fa-check"></i> Save Broker
            </button>
