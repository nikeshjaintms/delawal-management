...
<div class="stat-row">
    ...
    <div class="stat-box s-green">
        <div class="s-label">Active Brokers</div>
        <div class="s-value">{{ $activeBrokers }}</div>
    </div>
</div>

<div class="section-label">&#9632; Broker Records</div>
<table>
    <thead>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $item->project->project_name ?? 'General / All' }}</td>
            <td>{{ $item->city ?: '-' }}</td>
            <td>{{ $item->commission_percentage ? $item->commission_percentage . '%' : '-' }}</td>
            <td class="c">
        ...
        @empty
        <tr><td colspan="9" style="text-align:center;padding:20px;color:#64748B;">No broker records found.</td></tr>
        @endforelse
    </tbody>
</table>

<div class="rpt-footer">
    <span>Delawala Management System &nbsp;—&nbsp; Brokers Directory</span>
