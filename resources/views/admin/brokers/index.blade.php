    ...
    <div class="table-container">
        <table class="premium-table">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-action-buttons">
                                <a href="{{ route('brokers.show', $broker->id) }}" class="btn-view">
                                    <i class="fa fa-eye"></i> View
                                </a>
                                <a href="{{ route('brokers.edit', $broker->id) }}" class="btn-edit">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <form action="{{ route('brokers.destroy', $broker->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" onclick="return confirm('Are you sure you want to delete this broker?')" class="btn-delete">
                ...
                @empty
                    <tr>
                        <td colspan="8" align="center" style="padding: 30px; color: var(--text-secondary);">No brokers found in this firm.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
