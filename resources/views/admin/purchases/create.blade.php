...
<div class="crud-header">
    <div class="crud-title">
        ...
        <p>Fill in the details to record a new purchase.</p>
    </div>
</div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="item_name" id="item_name"
                           value="{{ old('item_name') }}"
                           class="form-control @error('item_name') is-invalid @enderror" placeholder="e.g. Cement, Steel Rods">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="quantity" id="quantity"
                           ...
                           class="form-control @error('quantity') is-invalid @enderror" placeholder="1" min="0" step="any">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="payment_status" id="payment_status" class="form-control @error('payment_status') is-invalid @enderror">
                        @foreach(['unpaid','partial','paid'] as $ps)
                            <option value="{{ $ps }}" {{ old('payment_status', 'unpaid') == $ps ? 'selected' : '' }}>
                                {{ ucfirst($ps) }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="reference_no" id="reference_no"
                           ...
                           class="form-control @error('reference_no') is-invalid @enderror" placeholder="Bill / Invoice / PO number">
