                    ...
                    <div id="category-input-wrapper" style="display: none; margin-top: 4px;">
                        <div style="display: flex; gap: 8px;">
                            <input type="text" name="expense_category" id="expense_category_custom"
                                   value="{{ old('expense_category', (!isset($expense->expense_category_id) && isset($expense->expense_category) ? $expense->expense_category : '')) }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    @if(old('expense_category') || (!$expense->expense_category_id && !empty($expense->expense_category)))
        toggleCategoryMode();
    @endif
});
</script>
