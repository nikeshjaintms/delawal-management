        ...
        <div class="form-grid">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="number" step="0.01" name="purchase_price" id="purchase_price" value="{{ old('purchase_price') }}" class="form-control" placeholder="e.g. 5000000.00" style="padding-left: 30px; font-weight: 700; font-size: 15px; color: #34D399; border-color: rgba(16, 185, 129, 0.4);">
                        </div>
            ...
            <div class="form-group">
                ...
                <div style="display: flex; gap: 8px;">
                    <input type="number" step="0.01" name="total_area" value="{{ old('total_area') }}" class="form-control" placeholder="e.g. 15000">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="purchase_rate" value="{{ old('purchase_rate') }}" class="form-control" placeholder="e.g. 1200.00">
