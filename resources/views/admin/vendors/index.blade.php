    ...
    <div class="table-container">
        <table class="premium-table">
            ...
            <tbody>
                        ...
                        <td>
                            <div class="table-action-buttons">
                                ...
                                <form action="{{ route('vendors.destroy', $vendor->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" onclick="return confirm('Are you sure you want to delete this vendor?')" class="btn-delete">
                ...
                @empty
                    <tr>
                        <td colspan="9" align="center" style="padding: 30px; color: var(--text-secondary);">No vendors found in this firm.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
