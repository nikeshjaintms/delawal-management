    ...
    <form method="POST" action="{{ route('vendors.store') }}">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter vendor or supplier name">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="gst_no" id="gst_no" value="{{ old('gst_no') }}" class="form-control @error('gst_no') is-invalid @enderror" placeholder="Enter vendor GST number" style="text-transform:uppercase;">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="payment_terms" id="payment_terms" value="{{ old('payment_terms') }}" class="form-control @error('payment_terms') is-invalid @enderror" placeholder="Enter payment terms, e.g. 15 days, 30 days, advance">
        ...
        <div class="form-group">
            ...
            <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" placeholder="Enter full address">{{ old('address') }}</textarea>
