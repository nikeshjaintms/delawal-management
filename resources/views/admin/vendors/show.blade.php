...
<div class="card-box">
    ...
    <div class="form-actions">
        <a href="{{ route('vendors.detail-pdf', $vendor->id) }}" target="_blank" class="btn-gold" style="background: rgba(252,105,0,0.18) !important; border: 1px solid rgba(252,105,0,0.45) !important; color: #FF8A3D !important; box-shadow: 0 4px 14px rgba(252,105,0,0.25);">
