...
<div class="crud-header"><div class="crud-title"><h2>Add Material Category</h2><p>Create a new inventory material category.</p></div></div>
<div class="card-box">
    <form method="POST" action="{{ route('material-categories.store') }}">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="category_name" id="category_name" value="{{ old('category_name') }}" class="form-control @error('category_name') is-invalid @enderror" autocomplete="off" placeholder="e.g. Cement, Steel, Paint">
        ...
        <div class="form-actions">
            <button type="submit" class="btn-gold"><i class="fa-solid fa-check"></i> Save Category</button>
