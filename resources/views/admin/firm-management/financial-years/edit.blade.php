...
@csrf @method('PUT')
    <div class="form-grid" style="margin-bottom:18px">
        ...
        <div class="form-group">
            ...
            <select name="status" class="form-control @error('status') is-invalid @enderror" required>
                <option value="active"   {{ old('status',$financialYear->status)=='active'   ? 'selected':'' }}>Active</option>
    ...
    <div class="form-action-buttons">
        <button type="submit" class="btn-primary-custom"><i class="fa fa-save"></i> Update Year</button>
