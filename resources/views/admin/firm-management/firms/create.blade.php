...
.logo-preview { width: 80px; height: 80px; object-fit: cover; border-radius: 10px; border: 1px solid rgba(255,255,255,0.15); display: none; }
    ...
    <div class="form-grid">
        ...
        <div class="form-group">
            ...
            <div style="position: relative;">
                <input type="password" name="password" id="password" class="form-control @error('password') is-invalid @enderror" placeholder="••••••••" required style="padding-right: 44px;">
        ...
        <div class="form-group">
            ...
            <div style="position: relative;">
                <input type="password" name="confirm_password" id="confirm_password" class="form-control @error('confirm_password') is-invalid @enderror" placeholder="••••••••" required style="padding-right: 44px;">
        ...
        <div class="form-group">
            ...
            <select name="status" class="form-control @error('status') is-invalid @enderror" required style="background: #101622 !important; color: #FFFFFF !important;">
                <option value="active"   {{ old('status','active')=='active'   ? 'selected':'' }} style="background: #101622; color: #FFFFFF;">Active</option>
                <option value="inactive" {{ old('status')=='inactive' ? 'selected':'' }} style="background: #101622; color: #FFFFFF;">Inactive</option>
            </select>
...
<div class="form-action-buttons">
    ...
    <a href="{{ route('firm-master.index') }}" class="btn-secondary-custom"><i class="fa fa-times"></i> Cancel</a>
</div>
</form>
