        ...
        <div class="form-group">
            ...
            <select name="firm_ids[]" id="firm_ids" class="form-control select2-multi @error('firm_ids') is-invalid @enderror" multiple required data-placeholder="Search and select firm(s)..." style="background: #101622 !important; color: #FFFFFF !important;">
                @foreach($firms as $firm)
                    <option value="{{ $firm->id }}" {{ in_array($firm->id, old('firm_ids', $invoiceSetting->firms->pluck('id')->toArray())) ? 'selected' : '' }} style="background: #101622; color: #FFFFFF;">
                        {{ $firm->firm_name }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            ...
            <select name="financial_year_id" id="financial_year_id" class="form-control @error('financial_year_id') is-invalid @enderror" style="background: #101622 !important; color: #FFFFFF !important;">
                ...
                @foreach($financialYears as $fy)
                    <option value="{{ $fy->id }}" {{ old('financial_year_id', $invoiceSetting->financial_year_id) == $fy->id ? 'selected' : '' }} style="background: #101622; color: #FFFFFF;">
...
<div class="form-card">
    ...
    <div class="form-grid">
        <div class="form-group">
            ...
            <input type="text" name="booking_prefix" value="{{ old('booking_prefix', $invoiceSetting->booking_prefix) }}" class="form-control @error('booking_prefix') is-invalid @enderror" maxlength="20">
        ...
        <div class="form-group">
            ...
            <input type="text" name="sale_prefix" value="{{ old('sale_prefix', $invoiceSetting->sale_prefix) }}" class="form-control @error('sale_prefix') is-invalid @enderror" maxlength="20">
        ...
        <div class="form-group">
            ...
            <input type="text" name="receipt_prefix" value="{{ old('receipt_prefix', $invoiceSetting->receipt_prefix) }}" class="form-control @error('receipt_prefix') is-invalid @enderror" maxlength="20">
        ...
        <div class="form-group">
            ...
            <input type="text" name="payment_prefix" value="{{ old('payment_prefix', $invoiceSetting->payment_prefix) }}" class="form-control @error('payment_prefix') is-invalid @enderror" maxlength="20">
        ...
        <div class="form-group">
            ...
            <input type="text" name="rental_prefix" value="{{ old('rental_prefix', $invoiceSetting->rental_prefix) }}" class="form-control @error('rental_prefix') is-invalid @enderror" maxlength="20">
        ...
        <div class="form-group">
            ...
            <input type="text" name="po_prefix" value="{{ old('po_prefix', $invoiceSetting->po_prefix) }}" class="form-control @error('po_prefix') is-invalid @enderror" maxlength="20">
        ...
        <div class="form-group">
            ...
            <input type="text" name="purchase_prefix" value="{{ old('purchase_prefix', $invoiceSetting->purchase_prefix) }}" class="form-control @error('purchase_prefix') is-invalid @enderror" maxlength="20">
        ...
        <div class="form-group">
            ...
            <input type="text" name="credit_note_prefix" value="{{ old('credit_note_prefix', $invoiceSetting->credit_note_prefix) }}" class="form-control @error('credit_note_prefix') is-invalid @enderror" maxlength="20">
        ...
        <div class="form-group">
            ...
            <input type="text" name="debit_note_prefix" value="{{ old('debit_note_prefix', $invoiceSetting->debit_note_prefix) }}" class="form-control @error('debit_note_prefix') is-invalid @enderror" maxlength="20">
...
<div class="form-action-buttons">
    <button type="submit" class="btn-primary-custom"><i class="fa fa-save"></i> Update Invoice Settings</button>
